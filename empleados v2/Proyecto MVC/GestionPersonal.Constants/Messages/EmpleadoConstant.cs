...
public static class EmpleadoConstant
{
    ...
    public const string EmpleadoCreado          = "El empleado fue registrado exitosamente.";
    public const string EmpleadoActualizado     = "El empleado fue actualizado exitosamente.";
}
